...
const Map = () => {
    ...
    const getPeriodColorScale = (interpolationMode) => {
    ...
    const toggleParameter = () => {
        ...
        if (map.current) {
            map.current.setPaintProperty('wave-height-grid-layer', 'fill-color', 
                getColorScale(colorMode, interpolationMode));
        }
    };
            ...
            map.current.on('load', async () => {
                ...
                try {
                    ...
                    map.current.addLayer({
                        ...
                        'paint': {
                            'fill-color': getColorScale(colorMode, interpolationMode),
                            'fill-opacity': 0.8
                        }
                    });
        ...
        <div className="relative w-full h-full">
            ...
            <div className="absolute top-20 pt-10 right-4 flex flex-col gap-2">
                ...
                <button
                    ...
                    className="bg-white px-3 py-2 rounded shadow z-10 hover:bg-gray-100"
                >
                    {visualParam === 'height' ? 'Show Period' : 'Show Height'}
                </button>
                <button
